...
10. **Elastic IP for technical-test-ariane EC2 instance (aws_eip.technical_test_ariane_eip)**
    Depends on:
...
11. **Network Interface (aws_network_interface.technical-test-public)**
